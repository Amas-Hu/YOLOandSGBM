...
if __name__ == '__main__':
    ...
    model.train(data=r'MyDataset\biye1.v1-roboflow-instant-1--eval-.yolov8\data.yaml',
                ...
                #resume='runs/train5(DUO-main-4)/yolov8n/weights/last.pt', # 如过想续训就设置last.pt的地址
