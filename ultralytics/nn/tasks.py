...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 RepNCSPELAN4_low, C2f_DynamicConv, DynamicConv, Down_wt, C2f_GhostModule_DynamicConv, C2f_WTConv,
                 C2f_SCSA1, C2f_SCSA2
                 ):
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_ACmix, C2f_AKConv,
                     ...
                     C2f_GhostModule_DynamicConv, C2f_WTConv, C2f_SCSA1, C2f_SCSA2):
        ...
        #---------------------------------------注意力机制------------------------
                   ...
                   deformable_LKA_Attention, FocalModulation, FocusedLinearAttention, iRMB, LSKA, TripletAttention,
                   OREPA, SCINet, Dy_Sample, CA, iAT, MultiSEAM, SEAM, deformable_LKA_Attention, ECA, GAM, CoordAtt, CBAM,
                   SPDEMA, AirNet, ADNet, RIDNET, SCSA}:
            c2 = ch[f]
            args = [c2, *args]
        # ---------------------------------------注意力机制-----------------------
        # ---------------------------------------主干----------------------------
